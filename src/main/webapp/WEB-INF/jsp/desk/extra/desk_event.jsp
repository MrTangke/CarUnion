...
<ul class="navmenu">
  <li><a href="<%=basePath%>desk/toIndex">首页</a><span></span></li>
		...
		<li class="active"><a href="<%=basePath%>desk/toEvent">优惠活动</a><span></span></li>
...
<div class="mainbox" style="width: 100%"  >
  ...
  <div align="center" style="width: 100%;" >
    <div class="main_con" style="width: 100%;float: left;background: transparent;background-image: url('<%=basePath %>img/desk/lzp3.jpg');">
      <div class="crumbs" style="position: relative;right: 68px;width: 1000px;"><span>本日活动</span></div>
	    <div align="center" style="padding-top: 60px;position: relative;left: 560px;" >
	    	<div style="padding: 20px;align-items: center;" class="price_button" id="sendprice" onclick="javascript:layer.msg('暂无优惠活动')">获取优惠券</div>
		</div>
	    <div class="cs-list" >
			<p style="font-size: 4mm;float: left;position: relative;left: 600px;bottom: 20px;" >&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;<font color="white" >我们的工作在于客户的满意度，为了提升我们公司的<br/>
			知名度，我们会不定时发布优惠活动，来吸引客户的光临 。<br/>
	       		我们公司的宗旨在于客户至上，
	       	您的满意是我们工作的动力。</font>
	       	</p>
		</div>
								    ...
								    $.post(
								    	...
								    	function(msg){
								    		...
								    		if(msg==2){
								    		    ...
								    		    location = "<%=basePath%>desk/toEvent";
