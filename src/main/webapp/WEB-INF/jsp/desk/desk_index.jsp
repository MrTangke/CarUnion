				...
				<div class="slide">
					...
					<div class="bd">
						<ul>
							<li>
								<div class="bd-dl">
									<a href="#" class="aImg"> <img
										src="<%=basePath%>img/desk/lzp3.jpg" />
									</a>
									<div class="joininfor">
										<h4>当漂移车手 遇见限量A8</h4>
										<p>今年的明星车辆、全省唯一一辆橙色奥迪A8L，他的买家是一位身份特殊的勇士，一位知名的...</p>
										<div align="right">
											<a href="<%=basePath%>desk/toReport" class="cMore">查看详情</a>
										</div>
									</div>
								</div>
								<div class="bd-dl">
									<a href="#" class="aImg"> <img
										src="<%=basePath%>img/desk/lzp1.jpg" />
									</a>
									<div class="joininfor">
										<h4>青藏川藏 曲水流觞</h4>
							...
							<li>
								<div class="bd-dl">
									<a href="newsinfor.html" class="aImg"> <img
										src="<%=basePath%>img/desk/car/aodi_img/waiyouce.jpg" />
									</a>
									<div class="joininfor">
										<h4>当漂移车手 遇见限量A8</h4>
										<p>今年的明星车辆、全省唯一一辆橙色奥迪A8L，他的买家是一位身份特殊的勇士，一位知名的...</p>
							...
							<li>
								<div class="bd-dl">
									<a href="newsinfor.html" class="aImg"> <img
										src="<%=basePath%>img/desk/car/aodi_img/waizuoce.jpg" />
									</a>
									<div class="joininfor">
										<h4>当漂移车手 遇见限量A8</h4>
				...
				<div class="r-news-list">
					<ul>
						<li><span class="date">11月02日</span><i class="icon "></i><a
							href="<%=basePath%>desk/toReport" title="石晋荣即日担任腾讯公司副总裁"> 石晋荣即日担任腾讯公司副总裁 </a></li>
						<li><span class="date">10月10日</span><i class="icon "></i><a
							href="<%=basePath%>desk/toReport" title="阿里公司第十九罗汉韩涛上任"> 阿里公司第十九罗汉韩涛上任 </a></li>
						<li><span class="date">09月28日</span><i class="icon "></i><a
							href="<%=basePath%>desk/toReport" title="百度公司重金引入葛庭玮,作为人工智能领域代表">
								百度公司重金引入葛庭玮,作为人工智能领域代表</a></li>
						<li><span class="date">09月13日</span><i class="icon "></i><a
							href="<%=basePath%>desk/toReport" title="谷歌阿尔法狗技术总监刘泽鹏归国">
								谷歌阿尔法狗技术总监刘泽鹏归国</a></li>
						<li><span class="date">09月13日</span><i class="icon "></i><a
							href="<%=basePath%>desk/toReport" title="北京八维技术研修学院面临破产危机">
