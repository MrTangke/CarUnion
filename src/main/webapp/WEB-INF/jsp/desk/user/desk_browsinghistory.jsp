		...
		<div class="meb-cont clearfix mainbox">
			<div class="meb-nav fl dInline">
				...
				<li ><a href="<%=basePath%>deskUser/toUser?userId=${sessionScope.user.userId}" id="b-regist">我的主页</a></li>
                    ...
                    <li class="on"><a href="<%=basePath %>/deskUser/browsinghistory?userId=${sessionScope.user.userId}">历史浏览</a></li>		
                </ul>
			</div>
            ...
            <p>
				...
				<div class="mr-detail">
							<div class="mr-tab clearfix">
								<a class="on">我浏览的车型</a>
								<a style="cursor: pointer;" onclick="clearAll()"><span style="color: gray;">清空记录</span></a>
								<script type="text/javascript">
								function clearAll(){
					    			layer.confirm("确定要删除您的历史浏览记录吗?",function(index){
					    				$.post(
							    				"<%=basePath %>deskExtra/clearHistory",
							    				function(msg){
							    					layer.msg('您已清空记录', {time:300},
							    							function(){
							    							location = "<%=basePath %>deskUser/browsinghistory";
							    						});	
							    				},"json"
							    			)
					    			});
							...
							<c:forEach items="${list2 }" var="list2">
												...
												<li class="clearfix" style="position: relative;"><span
													class="carImg fl dInline"><a href="#"
														target="_blank"><div class="car_bg"></div> <img
															src="<%=basePath %>${list2.carImg}" width="300"></a> </span>
													<div class="carTxt fr dInline">
														<h2>
															<a href="#" target="_blank">${list2.carName } </a>
														</h2>
														<p>
														...
														<div class="cs_bt clearfix">
															<a href="<%=basePath %>deskDriver/toDrive?id=${list2.carId}" class="cs-q">立即抢订</a> <a
																href="<%=basePath %>deskDriver/toCarInfo?id=${list2.carId}" >查看具体信息</a>
														</div>
													</div></li>
