...
<div class="egc-top">
	...
	<ul class="navmenu">
		...
		<li><a href="<%=basePath%>deskDriver/toCarManager">预约试驾</a><span></span></li>
		...
		<div class="meb-cont clearfix mainbox">
			<div class="meb-nav fl dInline">
				...
				<li ><a href="<%=basePath%>deskUser/toUser?userId=${sessionScope.user.userId}" id="b-regist">我的主页</a></li>
                    ...
                    <li class="on"><a href="<%=basePath %>/deskUser/comment?userId=${sessionScope.user.userId}">我的评论</a></li>	
					...
					<th>评论日期</th>
									...
									<tbody>
										<c:forEach items="${list2}" var="list2">
											<tr>
												<td>
					<a href="<%=basePath%>/deskDriver/toCarInfo?id=${list2.carId}&carName=${list2.carName}">${list2.carName }</a>
					</td>
					<td>
					${list2.commentContent }
					</td>
					<td>
					${list2.commentTime }
					</td>
