...
<html>
  ...
  <article class="page-container">
	<form action="<%=basePath%>adminBrand/insertBrand" class="form form-horizontal" id="Form" method="post">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>品牌名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="brandName" size="50" datatype="*" nullmsg="请输入品牌名称" />
			</div>
		</div>
