...
<html>
  ...
  <article class="page-container">
	<form action="<%=basePath%>adminCarImg/updateCarImg" class="form form-horizontal" id="Form" method="post" enctype="multipart/form-data">
		<input type="hidden" name="imgId" value="${carImg.imgId }" />
			...
			<div class="formControls col-xs-8 col-sm-9">
						<div class="row clearfix">
							<div class="col-md-12 column">
								<img src="<%=basePath%>${carImg.imgAddress}"  class="img-circle" style="width: 200px; height: 200px;" />
							</div>
						</div>
			</div>
		</div>
