...
<html>
  ...
  <article class="page-container">
	<form action="<%=basePath%>adminProducer/insertProducer" class="form form-horizontal" id="Form" method="post">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>生产商名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="proName" size="50" datatype="*" nullmsg="请输入生产商名称" />
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>联系人</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="peopleName" size="50" datatype="*" nullmsg="请输入联系人" />
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>联系人电话</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="peopleTel" size="50" datatype="*" nullmsg="请输入联系人电话" />
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="proAddress" size="50" datatype="*" nullmsg="请输入生产商详细地址" />
			</div>
		</div>
		 <div class="row cl">
