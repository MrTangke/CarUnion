...
<html>
  ...
  <article class="page-container">
	<form action="<%=basePath%>adminExtra/insertCycleImg" class="form form-horizontal" id="Form" method="post" enctype="multipart/form-data">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>图片名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="imgName" size="50" datatype="*" nullmsg="请输入图片名称" />
			</div>
		</div>
	<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
			     <input type="radio" name="imgType" value="1"/>上
			     <input type="radio" name="imgType" value="2"/>中
			     <input type="radio" name="imgType" value="3"/>下
