...
<html>
  ...
  <article class="page-container">
	<form action="<%=basePath%>/adminCoupon/CouponInsert" class="form form-horizontal" id="Form" method="post" >
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>优惠名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="couponName" size="50" datatype="*" nullmsg="请输入优惠券名称" />
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>优惠金额：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="couponMoney" size="50" datatype="*" nullmsg="请输入优惠金额" />
			</div>
		</div>
	    <div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>优惠简介：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="couponContent" size="50" datatype="*" nullmsg="请输入优惠简介" />
			</div>
		</div>
	   	...
	   	<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="couponUsedeadline" size="50" datatype="*" nullmsg="请输入截止日期" 
				onclick="WdatePicker()"/>
			</div>
		</div>
