...
<html>
  ...
  <article class="page-container">
	<form action="<%=basePath%>adminColor/insertColor" class="form form-horizontal" id="Form" method="post">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>颜色名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="colorName" size="50" datatype="*" nullmsg="请输入颜色名称" />
			</div>
			<label class="form-label col-xs-4 col-sm-3" style="float: left;"><span class="c-red">*</span>选择颜色：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="color" class="input-text" name="colorRgb" size="10" datatype="*" nullmsg="请选择颜色"/>
			</div>
		</div>
