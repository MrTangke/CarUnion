...
<html>
  ...
  <article class="page-container">
	<form action="<%=basePath%>adminBrand/updateBrand" class="form form-horizontal" id="Form" method="post">
		<input type="hidden" name="brandId" value="${brand.brandId }" />
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>生产商名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="brandName" size="50" datatype="*" nullmsg="请输入生产商名称" value="${brand.brandName }" />
			</div>
		</div>
		 <div class="row cl">
