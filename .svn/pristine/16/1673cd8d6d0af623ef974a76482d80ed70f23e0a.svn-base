...
<div class="mebBox">
		<div class="meb-cont clearfix mainbox">
			<div class="meb-nav fl dInline">
				<ul class="clearfix">
				<li class="on"><a href="<%=basePath%>deskUser/toUser?userId=${sessionScope.user.userId}">我的主页</a></li>
    ...
    <div class="mr-top-div clearfix">
        <span class="fl">
             <img width="80" height="80" src="<%=basePath%>/${list.userImg }" alt="暂无图片">
        </span>
        <div class="mr-infor fl dInline" style="padding-top: 0px;">
            <h2>中午好，尊敬的会员 <b>${list.realName }</b><br>
         <font color="#F7962F">   您的会员等级为 :  <font color="red">${list2.levelName }</font></font>
            </h2>
            <p>
                手机 ：${list.userTel }&emsp;&emsp;邮箱 ：${list.userEmails } 
            </p>
        </div>
    </div>
</div>
				<div class="mr-detail">
					<div class="me-box">
						<div class="mx-a">
							<ul class="clearfix">
								<li style="width: 455px;margin-bottom: 20px;float: left;">
									<img src="<%=basePath%>img/desk/index_img/hu2.png">
									<span>您共有 <a href="<%=basePath %>/deskUser/toCollect?userId=${sessionScope.user.userId}"><b>${colNum}</b></a> 个收藏车型</span>
								</li>
								<li style="width: 455px;float: right;margin-bottom: 20px;">
									<img src="<%=basePath%>img/desk/index_img/hu2.png">
									<span>您共有 <a href="<%=basePath %>/deskUser/toUserLy?userId=${sessionScope.user.userId}"><b>${tsNum}</b></a> 个推送信息</span>
								</li> 
								<li style="width: 455px;margin-bottom: 20px;float: left;">
									<img src="<%=basePath%>img/desk/index_img/hu2.png">
									<span>您共有 <a href="<%=basePath %>/deskUser/comment?userId=${sessionScope.user.userId}"><b>${plNum}</b></a> 个评论车型</span>
								</li>
								<li style="width: 455px;float: right;margin-bottom: 20px;">
									<img src="<%=basePath%>img/desk/index_img/hu2.png">
									<span>您共有 <a href="<%=basePath %>/deskUser/toOrderform?userId=${sessionScope.user.userId}"><b>${ddNum}</b></a> 个预订订单</span>
								</li>
								<li style="width: 455px;margin-bottom: 20px;float: left;">
									<img src="<%=basePath%>img/desk/index_img/hu2.png">
									<span>您共有 <a href="<%=basePath %>/deskUser/toCoupon?userId=${sessionScope.user.userId}"><b>${hhNum}</b></a> 个优惠活动</span>
								</li>
								<li style="width: 455px;float: right;">
									<img src="<%=basePath%>img/desk/index_img/hu2.png">
									<span>您共有 <a href="<%=basePath %>/deskUser/browsinghistory?userId=${sessionScope.user.userId}"><b>${llNum}</b></a> 个历史浏览</span>
								</li>
							</ul>
						</div>
