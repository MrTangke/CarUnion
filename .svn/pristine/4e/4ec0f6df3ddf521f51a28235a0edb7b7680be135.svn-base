...
<html>
  ...
  <article class="page-container">
	<form action="<%=basePath%>adminRepository/insertRepDistrict" class="form form-horizontal" id="Form" method="post">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>地址名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="disName" size="50" datatype="*" nullmsg="请输入地址名称" />
			</div>
		</div>
