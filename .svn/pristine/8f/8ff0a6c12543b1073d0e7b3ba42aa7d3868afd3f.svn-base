...
<html>
  ...
  <article class="page-container">
	<form action="<%=basePath%>adminCar/updateCarMessage" class="form form-horizontal" id="Form" method="post" enctype="multipart/form-data">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<option value="${brand.brandId}" ${cbm.brandId==brand.brandId?'selected':'' }>${brand.brandName}</option>
				</c:forEach>
				</select>
			</div>
		</div>
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<option value="${model.modelId}" ${cbm.modelId==model.modelId?'selected':'' }>${model.modelName}</option>
				</c:forEach>
				</select>
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<option value="${pro.proId}" ${cbm.producerId==pro.proId?'selected':'' }>${pro.proName}</option>
				</c:forEach>
				</select>
